...
-- 'root@localhost', 'SwayamDeeksha', '8.4.6', '2025-09-15 11:33:02'
...
Select (Salary * 0.10) as Bonus, (Salary + Salary * 0.10) as UpdatedSalary from Employees;
  
/* '6000.0000', '66000.0000'
'5500.0000', '60500.0000'
'7500.0000', '82500.0000'
'9000.0000', '99000.0000'
'5000.0000', '55000.0000'
'7000.0000', '77000.0000'
'5800.0000', '63800.0000'
'9800.0000', '107800.0000'
'6400.0000', '70400.0000'
'8500.0000', '93500.0000' */

-- Q2

Select (Salary * 0.15) as Tax, (Salary - Salary * 0.15) as SalaryAfterTax from Employees;

/* '9000.0000', '51000.0000'
'8250.0000', '46750.0000'
'11250.0000', '63750.0000'
'13500.0000', '76500.0000'
'7500.0000', '42500.0000'
'10500.0000', '59500.0000'
'8700.0000', '49300.0000'
'14700.0000', '83300.0000'
'9600.0000', '54400.0000'
'12750.0000', '72250.0000' */
...
Select (Age % 5) as AgeRemainderAfterDivBy5 from Employees;
...
Select * from Employees where Address NOT IN ('City G');
...
Select * from Employees where DepartmentID = 1 AND Year(HireDate) = 2022 Union Select * from Employees where DepartmentID = 1 AND Year(HireDate) = 2023;
